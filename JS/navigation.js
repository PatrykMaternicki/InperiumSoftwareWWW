...
if ( distance == nowPosition )
{
    if (startPosition == 0)
    {
		var transformPosition = nowPosition + 15 + "px";
		frame.style.transform = "" + 'translate( ' + '' + transformPosition + '' + ', -5px )' + "";
	...
	if (startPosition == 2)
		{
		var transformPosition = 8 + nowPosition + "px";
		frame.style.transform = "" + 'translate( ' + '' + transformPosition + '' + ', -5px )' + "";
	...
	if (startPosition == 3)
		{
		var transformPosition = 28 + nowPosition + "px";
		frame.style.transform = "" + 'translate( ' + '' + transformPosition + '' + ', -5px )' + "";
		    if (thisClicked == true && scrollDown == true)
		    {
		        console.log("cycki");
	...
	if (startPosition == 1)
		{
		var transformPosition = nowPosition + "px";
		frame.style.transform = "" + 'translate( ' + '' + transformPosition + '' + ', -5px )' + "";
		if (thisClicked == true && scrollDown == true) {
		    console.log("Hm?");
		        pointOne = true;
