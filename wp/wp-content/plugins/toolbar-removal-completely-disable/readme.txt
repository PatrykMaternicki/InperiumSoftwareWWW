=== Disable Admin Bar Toolbar ===
Contributors: sLaNGjI
Donate link: http://slangji.wordpress.com/donate/
Tags: sLaNGjIs, admin-bar, adminbar, disable-admin-bar, disable-toolbar, disable-wordpress-admin-bar, disable-wordpress-toolbar, disable-backend-admin-bar, disable-frontend-admin-bar, disable-backend-toolbar, disable-frontend-toolbar, toolbar
...
Is planned compatibility update for WordPress 3.8+ or greater? The plugin that is updated for compatibility with WordPress 3.8+ or greater, with mobility menu preservation, is [WP Admin Bar Removal](//wordpress.org/plugins/wp-admin-bar-removal/) and [WP ToolBar Removal](//wordpress.org/plugins/wp-toolbar-removal/) Please: migrate to it A.S.A.P.
...
`
= Development Status =
Developmental Code in Becoming! Branche 2013 Build 2016-01-04
= 2013.0615.2016.0 =
 ...
 * NEW Beta support (basic) for WP 3.8+ or greater (no mobility menu)
 ...
 * Bump Version 2013 Build 0615 Revision 2016 Update 0
